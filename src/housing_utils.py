...
def fit_baseline_model(df: pd.DataFrame):
    ...
    return model
# I excluded living_area, kitchen_area, and number_of_rooms from the baseline model because they overlap strongly with total area and may create multicollinearity.